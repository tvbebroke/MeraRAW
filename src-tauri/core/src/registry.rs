...
fn build_registry() -> BTreeMap<&'static str, ParamSpec> {
    ...
    let mut specs = vec![
        ...
        f32_spec("detail.noise_luma", 0.0, 100.0, 0.0, "Luminance", 1.0, "Noise Reduction"),
        f32_spec("detail.noise_chroma", 0.0, 100.0, 0.0, "Color", 1.0, "Noise Reduction"),
        f32_spec("detail.detail_preserve", 0.0, 100.0, 50.0, "Detail", 1.0, "Noise Reduction"),
        f32_spec("detail.chroma_auto", 0.0, 1.0, 1.0, "Color Auto", 1.0, "Noise Reduction"),
        f32_spec("detail.nr_strength", 0.25, 4.0, 1.0, "Strength", 0.05, "Noise Reduction"),
        f32_spec("detail.impulse", 0.0, 100.0, 0.0, "Impulse", 1.0, "Noise Reduction"),
        f32_spec("detail.hot_pixels", 0.0, 1.0, 1.0, "Hot Pixels", 1.0, "Noise Reduction"),
        f32_spec("detail.nr_engine", 0.0, 2.0, 0.0, "Engine", 1.0, "Noise Reduction"),
        f32_spec("detail.nr_aggressive", 0.0, 1.0, 0.0, "Aggressive", 1.0, "Noise Reduction"),
        f32_spec("detail.nlm_patch", 1.0, 3.0, 1.0, "NLM Patch", 1.0, "Noise Reduction"),
        f32_spec("detail.nlm_search", 2.0, 10.0, 5.0, "NLM Search", 1.0, "Noise Reduction"),
        f32_spec("detail.nlm_center", 0.0, 100.0, 30.0, "NLM Center", 1.0, "Noise Reduction"),
        f32_spec("detail.ai_enabled", 0.0, 1.0, 0.0, "AI Denoise", 1.0, "Noise Reduction"),
        f32_spec("detail.ai_amount", 0.0, 100.0, 50.0, "AI Amount", 1.0, "Noise Reduction"),
